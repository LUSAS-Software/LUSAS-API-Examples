...
| Geometry   | Use ObjectSets (Database, Groups, Selection etc) to filter features (points, lines, surface, nodes, elements etc) | 07_ObjectSets.py |
...
| Tools      | FCM Replace Multiple Varying with Tapered Sections | 140 FCM Replace Multiple Varying with Tapered Sections.py |
