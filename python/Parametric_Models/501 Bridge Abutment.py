...
try:
    ...
    #Surface 2
    surfLines2:'list[IFLine]' = lusas.newObjectSet().add(surface2).addLOF("Lines").getObjects("Line")
    wall_mesh_attr = database.createMeshLine("wall").setSize("BMI3",0.5)
    line_mesh_attr = database.createMeshLine("EL 1").setSize("NULL",0.5)
    for line in surfLines2:
    ...
    #Surface 3
    surfLines3: 'list[IFLine]' = lusas.newObjectSet().add(surface3).addLOF("Lines").getObjects("Line")
    wall_mesh_attr = database.createMeshLine("wall").setSize("BMI3",0.5)
    line_mesh_attr = database.createMeshLine("EL 1").setSize("NULL",0.5)
    for line in surfLines3:
