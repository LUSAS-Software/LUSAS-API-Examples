...
structLoadcase : 'IFLoadcase' = lusas.db().getLoadsets("loadcase", "all", structAnalysis.getName())[0]

# Find first thermal loadcase
thermalLoadcase : 'IFLoadcase' = lusas.db().getLoadsets("loadcase", "all", thermalAnalysis.getName())[0]
