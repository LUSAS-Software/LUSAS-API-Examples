...
assignedObjSet = lusas.newObjectSet().add(distrLoadAttr, getAsgn)
...
lusas.getTextWindow().writeLine(distrLoadAttr.getName() + " attribute is assigned on " + str(assignedObjSet.count("all")) + " features")
