...
assignedObjSet = lusas.newObjectSet().add(surfMeshAttr, getAsgn)
...
lusas.getTextWindow().writeLine(surfMeshAttr.getName() + " attribute is assigned on " + str(assignedObjSet.count("all")) + " features")
